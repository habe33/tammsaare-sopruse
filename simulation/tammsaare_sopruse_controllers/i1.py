...
from tammsaare_sopruse_controllers.configuration import PHASES_PATH, FLOWS_PATH, PRIORITIES_PATH, \
    PROTECTION_TSL_STATES_PATH, GREEN_TSL_STATES_PATH, LOGGING_PATH
from configuration.parser import construct_phases, read_protection_states, read_green_states
...
_config = Config(_phases, _protection_phases, _green_states, MAX_SPEED, TL_LOGIC_ID, INTERSECTION_NAME, LOGGING_PATH)
